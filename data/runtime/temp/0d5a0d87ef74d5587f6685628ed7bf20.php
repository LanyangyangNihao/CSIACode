<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"./application/admin/template/product/add.htm";i:1689649653;s:70:"/Users/gjj/hzwork/eyoucms/application/admin/template/public/layout.htm";i:1689649653;s:73:"/Users/gjj/hzwork/eyoucms/application/admin/template/public/theme_css.htm";i:1689649653;s:88:"/Users/gjj/hzwork/eyoucms/application/admin/template/archives/get_field_addonextitem.htm";i:1689649653;s:85:"/Users/gjj/hzwork/eyoucms/application/admin/template/product/old_product_attr_add.htm";i:1689649653;s:70:"/Users/gjj/hzwork/eyoucms/application/admin/template/public/footer.htm";i:1689649653;}*/ ?>
<!doctype html>
<html>
<head>
...
<div id="page_div" class="page min-hg-c mb-20" style="min-width:auto;box-shadow:none;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/add'); ?>" method="post">
        <!-- 常规信息 -->
        <div class="ncap-form-default tab_div_1">
            ...
            <?php if(!empty($shopConfig['shop_open']) && 1 == $shopConfig['shop_open']): if(empty($shopConfig['shop_type']) || (($shopConfig['shop_type'] instanceof \think\Collection || $shopConfig['shop_type'] instanceof \think\Paginator ) && $shopConfig['shop_type']->isEmpty())): ?><input type="hidden" name="prom_type" value="0"/><?php endif; if($shopConfig['shop_type'] == '1'): ?>
                ...
                <?php endif; if($shopConfig['shop_type'] == '2'): ?>
                    <!-- 两者都有 -->
                    <dl class="row">
                ...
                <?php endif; endif; if(1 == $shopConfig['shop_open'] && !empty($ifcontrolRow['users_price'])): if(!isset($shopConfig['shop_open_spec']) || 0 == $shopConfig['shop_open_spec']): ?>
                    <!-- 待添加后续逻辑... -->
                <?php else: ?>
                    <dl class="row">
            ...
            <?php endif; if(1 == $shopConfig['shop_open'] && !empty($ifcontrolRow['users_price'])): ?>
                ...
                <?php if(!isset($shopConfig['shop_open_spec']) || 0 == $shopConfig['shop_open_spec']): ?>
                    <!-- 待添加后续逻辑... -->
                <?php else: ?>
                    <script type="text/javascript">
                    ...
                    <script type="text/javascript">
                        ...
                        var RefreshPresetUrl = "<?php echo url('Shop/refresh_preset_value'); ?>";
                    ...
                    <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
                        ...
                        <ul>
                            <li>
                                ...
                                请先在【常规选项】里选择产品主栏目，再点击【<a href="<?php echo url('Product/attribute_index', array('typeid'=>$typeid)); ?>">参数选项</a>】进行更多操作。
                                <?php else: ?>
                                如果想对产品参数进行新增、修改、删除等操作，请点击【<a href="<?php echo url('Product/attribute_index', array('typeid'=>$typeid)); ?>">参数选项</a>】进行更多操作。
                                <?php endif; ?>
                            </li>
                        </ul>
                    </div>
...
<dl class="row" style="margin-top: 10px;" id="product_attr_table">
    ...
    <div style="color: red;font-size: 12px;text-align: center;">提示：该主栏目还没有参数值，若有需要请点击【<a href="<?php echo url('Product/attribute_index', array('typeid'=>$typeid)); ?>">参数选项</a>】进行更多操作。</div>
    <?php else: ?>
    <?php echo $canshu; endif; ?>
                        ...
                        <div id="system_param" style="display: block;">
                            <div class="selectPro_arg">
                                <select name="attrlist_id" id="attrlist_id" onchange="AttrListSelect(this);">
                                    ...
                                    <option value="<?php echo $vo['list_id']; ?>"><?php echo $vo['list_name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                &nbsp; &nbsp; &nbsp;
        ...
        <div class="ncap-form-default tab_div_4" style="display: none;">
            ...
            <dl class="row">
                ...
                <dd class="opt"> <input type="text" value="<?php echo $rand_arcclick; ?>" name="click" id="click" class="input-txt"> </dd>
            </dl>
            <dl class="row">
